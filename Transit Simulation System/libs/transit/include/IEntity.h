...
class IEntity {
 public:
   ...
   * @param pickedUp
   */
  virtual void SetPickedUp(bool pickedUp) {}

  /**
   * @brief Set the To Robot strategy
   * @param strategyName string name of the strategy
   * @param start starting positin for the route
   * @param end ending position for the route
   */
  virtual void SetToRobot(std::string strategyName, Vector3 start,
                          Vector3 end) {}

  /**
   * @brief Set the To Destination strategy
   * @param strategyName string name of the strategy
   * @param start starting positin for the route
   * @param end ending position for the route
   */
  virtual void SetToDestination(std::string strategyName, Vector3 start,
                                Vector3 end) {}
   ...
   * @param entity
   */
  virtual void SetNearestEntity(IEntity* entity) {}
